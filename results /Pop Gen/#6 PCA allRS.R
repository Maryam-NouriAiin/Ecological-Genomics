...
setwd("/Users/maryamnouri-aiin/Desktop/Ecological-Genomics/Pop genomics/results/") # set the path to where you saved the pcANGSD results on your laptop
