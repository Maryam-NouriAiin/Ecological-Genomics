...
setwd("/Users/maryamnouri-aiin/Desktop/Ecological-Genomics-Pvt/homeworks/") # set the path to where you saved the pcANGSD results on your laptop
...
cols=c("#377eB8","#326895","#5A7812","#DD9803","#FFCB69","#FAF29E","#F6E113","#FBCA09", "#FBC656", "#F2D11C","#DEB15E", "#F2920D")


tiff('pc', units="in", width=13, height=8, res=300)
ggarrange(pc12, pc23 + rremove("x.text"), 
          labels = c("A", "B"),
       common.legend = TRUE, legend = "bottom")
dev.off()

pc12 <-ggscatter(data, x = "V1", y = "V2",
                color = "Pop",
                mean.point = TRUE,
                star.plot = TRUE) +
...
cols2=c("#377eB8","#EE9B00","#0A9396","#94D2BD","#FFCB69","#005f73","#E26D5C","#AE2012", "#6d597a", "#7EA16B","#d4e09b", "gray70")
